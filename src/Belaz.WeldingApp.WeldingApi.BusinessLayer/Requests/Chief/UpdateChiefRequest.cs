...
public class UpdateChiefRequest : IMapTo<Belaz.WeldingApp.Common.Entities.Users.Chief>
{
    ...
    {
        profile
            .CreateMap<UpdateChiefRequest, Belaz.WeldingApp.Common.Entities.Users.Chief>()
