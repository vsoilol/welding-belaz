...
public class UpdateWeldPassageInstructionRequestValidator : AbstractValidator<UpdateWeldPassageInstructionRequest>
{
    public UpdateWeldPassageInstructionRequestValidator(ApplicationContext context)
    {
        RuleFor(model => model.Id)
            ...
            .NotEmpty()
            .SetValidator(new SqlIdValidatorFor<UpdateWeldPassageInstructionRequest,
                Domain.Entities.TechnologicalProcessInfo.WeldPassageInstruction>(context))
