...
public class AssignProductToWeldersRequestValidator : AbstractValidator<AssignProductToWeldersRequest>
{
    public AssignProductToWeldersRequestValidator(ApplicationContext context)
    {
        RuleFor(model => model.ProductId)
            ...
            .NotEmpty()
            .SetValidator(new SqlIdValidatorFor<AssignProductToWeldersRequest,
