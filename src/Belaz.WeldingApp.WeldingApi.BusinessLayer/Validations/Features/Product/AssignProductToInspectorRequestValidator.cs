...
public class AssignProductToInspectorRequestValidator : AbstractValidator<AssignProductToInspectorRequest>
{
    public AssignProductToInspectorRequestValidator(ApplicationContext context)
    {
        RuleFor(model => model.InspectorId)
            ...
            .NotEmpty()
            .SetValidator(new SqlIdValidatorFor<AssignProductToInspectorRequest,
