...
public class UpdateWeldingEquipmentDowntimeRequestValidator
    : AbstractValidator<UpdateWeldingEquipmentDowntimeRequest>
{
    public UpdateWeldingEquipmentDowntimeRequestValidator(ApplicationContext context)
    {
        RuleFor(model => model.Id)
            ...
            .SetValidator(
                new SqlIdValidatorFor<
                    UpdateWeldingEquipmentDowntimeRequest,
        ...
        RuleFor(model => model.DowntimeReasonId)
            ...
            .NotEmpty()
            .SetValidator(
                new SqlIdValidatorFor<UpdateWeldingEquipmentDowntimeRequest, DowntimeReason>(
                    context
                )
            );
