...
public class UpdateDefectiveReasonToSeamRequestValidator
    : AbstractValidator<UpdateDefectiveReasonToSeamRequest>
{
    public UpdateDefectiveReasonToSeamRequestValidator(ApplicationContext context)
    {
        RuleFor(model => model.Id)
            ...
            .NotEmpty()
            .SetValidator(
                new SqlIdValidatorFor<UpdateDefectiveReasonToSeamRequest, DefectiveReason>(context)
            );
