...
public class WorkplaceService : IWorkplaceService
{
    ...
    public WorkplaceService(IValidationService validationService, IMapper mapper,
    ...
    public async Task<Result<WorkplaceDto>> GetByIdAsync(GetWorkplaceByIdRequest request)
    {
        ...
        return await validationResult.ToDataResult(() => _workplaceRepository.GetByIdAsync(request.Id));
    }
