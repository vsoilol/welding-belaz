...
public class WorkshopService : IWorkshopService
{
    ...
    public WorkshopService(IValidationService validationService, IMapper mapper, IWorkshopRepository workshopRepository)
    {
    ...
    public async Task<Result<WorkshopDto>> GetByIdAsync(GetByIdRequest request)
    {
        ...
        return await validationResult.ToDataResult(() => _workshopRepository.GetByIdAsync(request.Id));
    }
