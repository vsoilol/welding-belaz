...
public class ProductAccountTaskPassportDocument : IDocument
{
    private readonly string _fontsPath;

    public ProductAccountTaskPassportDocument(ProductAccountTaskDto task, string fontsPath)
    {
        Task = task;
        ...
        container.Column(column =>
        {
            ...
            column
                ...
                .Column(row =>
                {
                    ...
                    {
                        row.Item().Component(new SeamTaskComponent(seamTask));
                    }
                });
