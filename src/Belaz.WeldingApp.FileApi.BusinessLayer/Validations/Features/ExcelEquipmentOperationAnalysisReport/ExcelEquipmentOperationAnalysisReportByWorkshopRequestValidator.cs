...
public class ExcelEquipmentOperationAnalysisReportByWorkshopRequestValidator
    : AbstractValidator<ExcelEquipmentOperationAnalysisReportByWorkshopRequest>
{
    public ExcelEquipmentOperationAnalysisReportByWorkshopRequestValidator(
        ...
        RuleFor(model => model.WorkshopId)
            ...
            .SetValidator(
                new SqlIdValidatorFor<
                    ExcelEquipmentOperationAnalysisReportByWorkshopRequest,
                    Workshop
                >(context)
            );
