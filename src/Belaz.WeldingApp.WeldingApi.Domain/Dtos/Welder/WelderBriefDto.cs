...
public class WelderBriefDto : IMapFrom<Belaz.WeldingApp.Common.Entities.Users.Welder>
{
    ...
    {
        profile
            .CreateMap<Belaz.WeldingApp.Common.Entities.Users.Welder, WelderBriefDto>()
