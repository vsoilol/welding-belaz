...
public class ProductInsideDto : IMapFrom<Belaz.WeldingApp.Common.Entities.ProductInfo.Product>
{
    ...
    {
        profile
            .CreateMap<Belaz.WeldingApp.Common.Entities.ProductInfo.Product, ProductInsideDto>()
                ...
                opt =>
                    opt.MapFrom(
                        x =>
                            ...
                            ?? x.ProductMain!.MainProduct.TechnologicalProcess
                    )
            );
    }
}
