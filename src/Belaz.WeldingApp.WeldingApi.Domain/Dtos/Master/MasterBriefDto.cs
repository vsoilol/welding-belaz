...
public class MasterBriefDto : IMapFrom<Belaz.WeldingApp.Common.Entities.Users.Master>
{
    ...
    {
        profile
            .CreateMap<Belaz.WeldingApp.Common.Entities.Users.Master, MasterBriefDto>()
