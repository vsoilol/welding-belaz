...
export const CustomCalendar = ({
  ...
  const handleMonthChange = (date) => {
    ...
    if (mainCalendar.year === currentYear) {
      updateCalendarEvents(date);
      return;
    }

    if (mainCalendar.welderId) {
      loadCalendarByWelder(mainCalendar.welderId, currentYear);
      return;
    }

    if (mainCalendar.weldingEquipmentId) {
      loadCalendarByEquipment(mainCalendar.weldingEquipmentId, currentYear);
      return;
    }
  };
